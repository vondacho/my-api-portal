package io.obya.api.onboarding.appl.usecase.processing.playground.oas;
...
public class ParseAndValidateOpenAPITest {
    ...
    void parseAndValidate () {
        ...
        OpenApiResult openApiResult = parser.parse("/playground/api/oas/openapi.yaml");
        ...
        var overlayResult = overlayParser.parse("/playground/api/oas/overlay.yaml");
