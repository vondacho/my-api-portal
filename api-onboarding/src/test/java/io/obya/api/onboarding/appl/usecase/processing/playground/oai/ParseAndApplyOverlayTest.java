package io.obya.api.onboarding.appl.usecase.processing.playground.oai;
...
public class ParseAndApplyOverlayTest {
    ...
    void should_parse_overlay() throws IOException {
        final String overlay = Files.readString(Path.of("src/test/resources", "playground", "api", "oai", "overlay.yaml"));
        ...
        final String body = Files.readString(Path.of("src/test/resources", "playground", "api", "oas", "openapi.yaml"));
    ...
    void should_instantiate_then_apply_templated_overlay() throws IOException {
        final String template = Files.readString(Path.of("src/test/resources", "playground", "api", "oai", "overlay_template.yaml"));
